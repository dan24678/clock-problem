...
To satisfy the challenge, you must generate a sorted list of all 28 LEDs with the associated number of seconds that each LED is turned ON within a 24-hour period, given the following additional rules:
